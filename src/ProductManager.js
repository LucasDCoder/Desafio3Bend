...
//productos.addProduct('producto de prueba', 'Este es un producto de prueba', 200, 'Sin imagen', 'abc123', 25).then((res) => console.log(res));

//productos.getProductById(1).then(res => console.log(res));

//productos.getProductById(2).then(res => console.log(res));

//productos.updateProduct(1, 'update producto de prueba', 'Este es un producto de prueba', 200, 'Sin imagen', 'abc123', 25).then(()=> productos.getProducts().then((res) => console.log(res)));
